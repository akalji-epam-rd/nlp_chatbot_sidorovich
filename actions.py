...
class MemoryVisit(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if(uid is None):
            ...
            return [SlotSet('id', user_id)]
        else:
            u_inf = collection.find_one({"id": uid})
            time = u_inf['first_time']
            dispatcher.utter_message("Oooh, I remember your smily face. It was sooo long ago. Thanks Gods I still remember correct time. I've met you %s" % time)
        return []
